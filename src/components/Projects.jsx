        ...
        <Row>
            ...
            <div className={`card-${theme}`}>
              ...
              <Collapse in={open}>
                <div className={`colapse-text-${theme}`}>
                  eCommerce "Geekmitive", donde participe de manera activa en el
          ...
          <Col sm={6} lg={4} className="col-options">
            <div className={`card-${theme}`}>
              ...
              <Collapse in={open2}>
                <div className={`colapse-text-${theme}`}>
                  Demostración de desarrollo full stack. Utilizando el framework
                  React en el frontend y haciendo uso de API Rest en backend con
                  springboot y MySQL.
                </div>
              </Collapse>
              <div className="buttons-project">
          ...
          <Col sm={6} lg={4} className="col-options">
            <div className={`card-${theme}`}>
              ...
              <Collapse in={open3}>
                <div className={`colapse-text-${theme}`}>
                  Implementación de APIs proporcionadas por la NASA, elaborando
                  componentes web mediante la libreria Lit-element. Además de
                  HTML, CSS, Javascript y el framework React.
                </div>
              </Collapse>
              <div className="buttons-project">
                <Button
